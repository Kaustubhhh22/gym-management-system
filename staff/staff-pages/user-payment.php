              ...
              <div class="span5">
                <table class="">
                  ...
                  <tr>
                    ...
                    <tr>
                      <td><h4>One Fitness GYM Club</h4></td>
                    </tr>
                    <tr>
                      <td>5021 Shivaji Nagar, Ratnagiri</td>
                    </tr>
                    
                    <tr>
                      <td>Tel: 9822050738</td>
                    </tr>
                    <tr>
                      <td >Email: support@onefitness.com</td>
                    </tr>
                  </tbody>
                </table>
              </div>
                ...
                <table class="table table-bordered table-invoice">
				  ...
				  <form action="userpay.php" method="POST">
                    ...
                    <tr>
                      ...
                      <td><input id="amount" type="number" name="amount" value='<?php if($row['services'] == 'Fitness') { echo '500';} elseif ($row['services'] == 'Sauna') { echo '300';} else {echo '400';} ?>' /></td>
                    </tr>
...
<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date("Y");?> &copy; K-A-P</a> </div>
</div>
